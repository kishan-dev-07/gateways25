...
const EventModal = ({ isOpen, onClose, eventData }) => {
  ...
  const handleRegister = () => {
    const found = eventLinks.find(
      (e) => e["Event Name"] === eventData["Event Name"]
    );
    if (found && found.Link) {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background:
            "linear-gradient(135deg, #0f0f0f 0%, #1a0033 25%, #000011 50%, #001122 75%, #000000 100%)",
          boxShadow:
            "0 0 50px rgba(0, 255, 255, 0.3), inset 0 0 50px rgba(139, 69, 19, 0.1)",
        }}
      ...
      >
        ...
        <div className="absolute inset-0 rounded-lg opacity-20">
          ...
          <div
            className="absolute inset-0 bg-gradient-to-l from-transparent via-purple-500/20 to-transparent animate-pulse"
        ...
        <div className="relative p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
            <div className="bg-black/40 border border-cyan-500/20 rounded-lg p-4 hover:border-cyan-500/40 transition-colors duration-300">
              <div className="flex items-center gap-3 mb-2">
                ...
                <span className="text-[#D4FF00] text-sm font-mono">
                  Team Size
                </span>
              </div>
            ...
            <div className="bg-black/40 border border-purple-500/20 rounded-lg p-4 hover:border-purple-500/40 transition-colors duration-300">
              ...
              <div className="text-white font-bold">
                ₹{eventData["Prize Pool"]?.toLocaleString()}
              </div>
            </div>
          ...
          <>
            ...
            {eventData.Rules && eventData.Rules.length > 0 && (
              <div className="mb-8">
                ...
                <ul className="bg-black/20 border border-gray-700/50 rounded-lg p-6 list-disc list-inside text-gray-300 font-light">
          ...
          <>
            ...
            {eventData.Prerequisites && eventData.Prerequisites.length > 0 && (
              <div className="mb-8">
                ...
                <ul className="bg-black/20 border border-gray-700/50 rounded-lg p-6 list-disc list-inside text-gray-300 font-light">
                  {eventData.Prerequisites.map((pre, idx) => (
                    <li key={idx} className="mb-2">
                      {pre}
                    </li>
                  ))}
            ...
            <div className="mb-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {eventData["Event Heads"].map((head, index) => (
                  <div
                    key={index}
                    className="bg-black/30 border border-gray-700/30 rounded-lg p-4 hover:border-purple-500/40 transition-colors duration-300"
                  >
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button
              ...
              className="flex-1 bg-gradient-to-r  from-[#00FFFF] via-[#6FFF00] to-[#D4FF00] text-black font-bold py-4 px-8 rounded-lg transition-all duration-300 transform hover:scale-105 cursor-pointer hover:shadow-lg hover:shadow-cyan-500/25 font-mono uppercase tracking-wider"
            >
              Register Now
            </button>
            <button
